...
func logFile() *os.File {
	file, err := os.OpenFile("camis-v2-api-"+time.Now().Format("2006-01-02")+".log", os.O_APPEND|os.O_CREATE|os.O_WRONLY, 0666)
	if err != nil {
...
func singleLogFile(title string) *os.File {
	file, err := os.OpenFile("camis-v2-api-"+title+".log", os.O_APPEND|os.O_CREATE|os.O_WRONLY, 0666)
	if err != nil {
